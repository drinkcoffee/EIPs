...
This EIP defines the interface that allows stateless zero knowledge provers to collect state information from blockchain nodes that are operating as decentralized sequencers. This EIP is designed to be used in conjunction with EIP-75XXb, which defines a minimal set of properties for proving consensus, and EIP-75XXc, which defines a minimal set of properties for bridging.
